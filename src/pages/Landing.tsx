...
const Landing = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      {/* Header */}
      <header className="backdrop-blur-sm bg-white/30 border-b border-white/40">
        <div className="container mx-auto px-6 py-6 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-br from-orange-300 to-pink-300 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-200/50 relative">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/auth">
              <Button
                variant="ghost"
                className="text-gray-700 hover:text-orange-600 hover:bg-white/50 rounded-xl px-6"
              >
                Login
              </Button>
            </Link>
            <Link to="/auth">
              <Button className="bg-gradient-to-r from-orange-400 to-pink-400 hover:from-orange-500 hover:to-pink-500 text-white shadow-lg shadow-orange-200/50 rounded-xl px-6 py-3 transition-all duration-200 hover:shadow-xl hover:shadow-orange-300/50 hover:-translate-y-0.5">
                Get Started Free
              </Button>
            </Link>
          </div>
      ...
      <section className="container mx-auto px-6 py-24 text-center max-w-5xl relative">
        ...
        <Badge className="mb-8 bg-white/80 backdrop-blur-sm text-orange-700 hover:bg-white/90 border-0 text-sm font-medium shadow-lg shadow-orange-100/50 rounded-full px-4 py-2">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
          <Link to="/auth">
            <Button
              size="lg"
              className="bg-gradient-to-r from-orange-400 to-pink-400 hover:from-orange-500 hover:to-pink-500 text-white text-lg px-10 py-4 rounded-2xl shadow-xl shadow-orange-200/50 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-300/60 hover:-translate-y-1 font-semibold"
            >
              Start Free Trial
          ...
          <Button
            size="lg"
            variant="outline"
            className="text-lg px-10 py-4 rounded-2xl border-2 border-orange-200 text-orange-700 hover:bg-white/80 backdrop-blur-sm shadow-lg shadow-orange-100/30 hover:shadow-xl hover:shadow-orange-200/40 transition-all duration-300 hover:-translate-y-0.5 font-semibold bg-white/60"
          >
            Watch Demo
      ...
      <section className="container mx-auto px-8 lg:px-12 pt-6 pb-12 max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
          <Card className="group hover:shadow-2xl hover:shadow-orange-200/30 transition-all duration-300 border-0 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-orange-100/20 hover:-translate-y-2">
            <CardHeader className="p-8">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-blue-200/50 group-hover:scale-110 transition-transform duration-300">
          ...
          <Card className="group hover:shadow-2xl hover:shadow-orange-200/30 transition-all duration-300 border-0 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-orange-100/20 hover:-translate-y-2">
            <CardHeader className="p-8">
              <div className="w-16 h-16 bg-gradient-to-br from-purple-400 to-purple-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-purple-200/50 group-hover:scale-110 transition-transform duration-300">
          ...
          <Card className="group hover:shadow-2xl hover:shadow-orange-200/30 transition-all duration-300 border-0 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-orange-100/20 hover:-translate-y-2">
            <CardHeader className="p-8">
              <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-green-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-green-200/50 group-hover:scale-110 transition-transform duration-300">
          ...
          <Card className="group hover:shadow-2xl hover:shadow-orange-200/30 transition-all duration-300 border-0 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-orange-100/20 hover:-translate-y-2">
            <CardHeader className="p-8">
              <div className="w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-400 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-yellow-200/50 group-hover:scale-110 transition-transform duration-300">
          ...
          <Card className="group hover:shadow-2xl hover:shadow-orange-200/30 transition-all duration-300 border-0 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-orange-100/20 hover:-translate-y-2">
            <CardHeader className="p-8">
              <div className="w-16 h-16 bg-gradient-to-br from-pink-400 to-pink-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-pink-200/50 group-hover:scale-110 transition-transform duration-300">
          ...
          <Card className="group hover:shadow-2xl hover:shadow-orange-200/30 transition-all duration-300 border-0 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-orange-100/20 hover:-translate-y-2">
            <CardHeader className="p-8">
              <div className="w-16 h-16 bg-gradient-to-br from-indigo-400 to-indigo-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-indigo-200/50 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="container mx-auto px-8 lg:px-12 relative max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-24 xl:gap-32 items-center">
            ...
            <div>
              ...
              <div className="space-y-10">
                <div className="flex items-start space-x-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-green-400 to-green-500 rounded-2xl flex items-center justify-center shadow-lg shadow-green-200/50 flex-shrink-0">
                ...
                <div className="flex items-start space-x-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-500 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-200/50 flex-shrink-0">
                    <CheckCircle className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-xl text-gray-800 mb-3">
                ...
                <div className="flex items-start space-x-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-400 to-purple-500 rounded-2xl flex items-center justify-center shadow-lg shadow-purple-200/50 flex-shrink-0">
                    <CheckCircle className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-xl text-gray-800 mb-3">
                ...
                <div className="flex items-start space-x-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-pink-400 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg shadow-pink-200/50 flex-shrink-0">
                    <CheckCircle className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-xl text-gray-800 mb-3">
            ...
            <div className="relative">
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl shadow-orange-200/30 p-10 border border-white/50">
                <div className="flex items-center justify-between mb-8">
                  <h3 className="text-2xl font-bold text-gray-800">
                    Campaign Performance ✨
                  </h3>
                  <Badge className="bg-gradient-to-r from-green-400 to-green-500 text-white border-0 px-4 py-2 rounded-full shadow-lg shadow-green-200/50">
                    +127% ROI
                  </Badge>
                </div>
      ...
      <section className="py-20 bg-white/50 backdrop-blur-sm">
        <div className="container mx-auto px-8 lg:px-12 max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-10 lg:gap-12">
            <Card className="border-0 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-orange-100/20 hover:shadow-2xl hover:shadow-orange-200/30 transition-all duration-300 hover:-translate-y-2">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-purple-400 rounded-2xl flex items-center justify-center mr-4 shadow-lg shadow-blue-200/50">
            ...
            <Card className="border-0 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-orange-100/20 hover:shadow-2xl hover:shadow-orange-200/30 transition-all duration-300 hover:-translate-y-2">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-green-400 to-teal-400 rounded-2xl flex items-center justify-center mr-4 shadow-lg shadow-green-200/50">
            ...
            <Card className="border-0 rounded-3xl bg-white/80 backdrop-blur-sm shadow-xl shadow-orange-100/20 hover:shadow-2xl hover:shadow-orange-200/30 transition-all duration-300 hover:-translate-y-2">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-pink-400 to-purple-400 rounded-2xl flex items-center justify-center mr-4 shadow-lg shadow-pink-200/50">
        ...
        <div className="container mx-auto px-8 lg:px-12 text-center relative max-w-6xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
            <Link to="/auth">
              <Button
                size="lg"
                className="bg-white text-orange-600 hover:bg-gray-50 text-xl px-12 py-4 rounded-2xl shadow-2xl shadow-white/20 transition-all duration-300 hover:shadow-3xl hover:-translate-y-1 font-bold"
              >
                Start Free Trial
                <ArrowRight className="w-6 h-6 ml-2" />
              </Button>
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white text-white hover:bg-white hover:text-orange-600 text-xl px-12 py-4 rounded-2xl backdrop-blur-sm bg-white/10 shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-0.5 font-bold"
            >
              Schedule Demo
          ...
          <div className="grid md:grid-cols-4 gap-12">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-10 h-10 bg-gradient-to-br from-orange-400 to-pink-400 rounded-2xl flex items-center justify-center shadow-lg relative">
                  <Bot className="w-6 h-6 text-white" />
                  <Sparkles className="w-3 h-3 text-yellow-300 absolute -top-1 -right-1" />
                </div>
